...
forge script script/${CONTRACT}.s.sol --rpc-url mumbai

# actually perform the deployment
SAVE_DEPLOYMENTS=1 forge script script/${CONTRACT}.s.sol --ffi --rpc-url mumbai --broadcast --verify

# optionally verify the contract as a separate step
forge verify-contract 0xA17f8d960B5a7A42174847213f3C5c19a7ef9dFd SingleBatchEdition --chain mumbai
```
